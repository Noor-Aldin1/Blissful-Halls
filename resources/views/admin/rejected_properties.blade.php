...
<div class="container mt-4">
    <h2 style="display: inline">Rejected Properties</h2>
 <div class="bt">
    <a class="btn btn-dark mt-2" href="{{ route('admin.properties.pending') }}" class="btn btn-primary">Pending</a>
        <a class="btn btn-dark mt-2"  href="{{ route('admin.properties.accepted') }}" class="btn btn-primary">Accepted</a>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.properties.pend', $property->id) }}" method="POST" style="display:inline-block;">
                            @csrf
                            <button type="submit" class="btn btn-danger">Pend</button>
                        </form>
                        <form action="{{ route('admin.properties.approve', $property->id) }}" method="POST" style="display:inline-block;">
                            @csrf
